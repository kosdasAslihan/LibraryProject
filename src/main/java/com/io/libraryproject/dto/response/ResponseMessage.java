...
public class ResponseMessage {
    ...
    public static final String BOOK_CREATED_RESPONSE_MESSAGE = "Book successfully saved" ;
    ...
    public static final String AUTHOR_SAVED_RESPONSE_MESSAGE = "Author successfully saved" ;
