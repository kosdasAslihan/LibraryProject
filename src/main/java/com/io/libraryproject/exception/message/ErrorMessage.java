...
public class ErrorMessage {
    ...
    public final static String PUBLISHER_NOT_FOUND_EXCEPTION = "Publisher with id : %s not found";
    public final static String CATEGORY_NOT_FOUND_EXCEPTION = "Category with id : %s not found";
    public final static String ROLE_NOT_FOUND_EXCEPTION = "Role with id : %s not found";
